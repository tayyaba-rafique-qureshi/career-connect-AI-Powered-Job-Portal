...
export const getUsers = (params) => {
  ...
  return api.get('/admin/users', { params: clean })
}
...
export const getJobs = (params) => {
  ...
  return api.get('/admin/jobs', { params: clean })
}
...
// Job Reports
export const getAllJobReports = (params) => {
  const clean = Object.fromEntries(
    Object.entries(params).filter(([, v]) => v !== '' && v !== undefined && v !== null)
  )
  return api.get('/admin/job-reports', { params: clean })
}
...
export const getApplications = (params) => {
  ...
  return api.get('/admin/applications', { params: clean })
}
...
export const getVerifications = (params) => {
  ...
  return api.get('/admin/verifications', { params: clean })
}
...
export const getAuditLogs = (params) => {
  ...
  return api.get('/admin/audit-logs', { params: clean })
}
