...
export default function JobDetails({ job, matchData, matchLoading, onApply, onSave, saved, applied, onDislike, disliked, allJobs = [], onSelectJob }) {
  ...
  const noResumeText = matchData?.noResumeText === true
  ...
  return (
    <div className="job-details-scroll" style={{ flex: 1, overflowY: 'auto', padding: '32px' }}>
      ...
      {matchLoading ? (
        ...
        /* New account whose resume text wasn't extracted yet — show a helpful prompt */
        <div style={{
          backgroundColor: 'var(--cc-amber-bg)', border: '1px dashed var(--cc-amber)',
          borderRadius: '8px', padding: '16px 20px', marginBottom: '24px',
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          gap: '12px', flexWrap: 'wrap',
        }}>
          <div>
            <p style={{ margin: '0 0 4px', fontSize: '14px', fontWeight: '700', color: 'var(--cc-amber)' }}>
              AI match score unavailable
            </p>
            <p style={{ margin: 0, fontSize: '13px', color: 'var(--cc-text-2)', lineHeight: 1.5 }}>
              Your resume hasn't been processed yet. Upload or re-upload your resume to enable AI match scoring.
            </p>
          </div>
          <a href="/profile" style={{
            display: 'inline-flex', alignItems: 'center', padding: '8px 16px',
            backgroundColor: 'var(--cc-amber)', color: 'white', borderRadius: '6px',
